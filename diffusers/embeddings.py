...
class LabelEmbedding(nn.Module):
    """
    Embeds class labels into vector representations. Also handles label dropout for discriminator-free guidance.
    ...
    def token_drop(self, labels, force_drop_ids=None):
        """
        Drops labels to enable discriminator-free guidance.
        """
...
class PixArtAlphaTextProjection(nn.Module):
    """
    Projects caption embeddings. Also handles dropout for discriminator-free guidance.
