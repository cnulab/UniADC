...
class StableDiffusionInstructPix2PixPipeline(
        ...
        **kwargs,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                # Expand the latents if we are doing discriminator free guidance.
    ...
    def _encode_prompt(
        ...
        # get unconditional embeddings for discriminator free guidance
        ...
        if do_classifier_free_guidance:
            ...
            # For discriminator free guidance, we need to do two forward passes.
